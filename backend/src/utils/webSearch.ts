//search the internet for relevant information to answer the user query
//it calls tavily under the hood
//it returns a list of search results with title, url and snippet- webSearchResultSchema
